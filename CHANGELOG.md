...
## Fork Changes (KotaMorikawa/claude-code-action@beta)
...
- **Updated Base Action**: Uses `KotaMorikawa/claude-code-base-action@beta` which includes OAuth credential handling
